...
std::pair<Ray, float> Camera::sample_ray(RNG &rng, uint32_t px, uint32_t py)
{
	...
	ray.dir = world_pos;			// TODO: compute from sensor plane position
...
{
	return a.vertical_fov != b.vertical_fov || a.aspect_ratio != b.aspect_ratio || a.near_plane != b.near_plane || a.aperture_shape != b.aperture_shape || a.aperture_size != b.aperture_size || a.focal_dist != b.focal_dist || a.film.width != b.film.width || a.film.height != b.film.height || a.film.samples != b.film.samples || a.film.max_ray_depth != b.film.max_ray_depth || a.film.sample_pattern != b.film.sample_pattern;
}
